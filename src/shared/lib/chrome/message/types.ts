...
export type MessageListenerResponse<
  Signature extends MessageSignature<any, any>
> = void | MessageResponse<Signature> | Promise<MessageResponse<Signature>>

export type BaseListenerMap = { [k: Index]: MessageSignature<any, any> }
